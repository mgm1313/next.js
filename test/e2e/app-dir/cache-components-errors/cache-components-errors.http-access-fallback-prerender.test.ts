          ...
          if (isTurbopack) {
            if (isDebugPrerender) {
              expect(output).toMatchInlineSnapshot(`
               "Error: Route "/not-found/[slug]": Next.js encountered uncached or runtime data during the initial render.
      ...
      if (isNextDev) {
        ...
        it('should error the build with a blocking-route error', async () => {
          ...
          if (isTurbopack) {
            if (isDebugPrerender) {
              expect(output).toMatchInlineSnapshot(`
               "Error: Route "/forbidden/[slug]": Next.js encountered uncached or runtime data during the initial render.
      ...
      if (isNextDev) {
        ...
        it('should error the build with a blocking-route error', async () => {
          ...
          if (isTurbopack) {
            if (isDebugPrerender) {
              expect(output).toMatchInlineSnapshot(`
               "Error: Route "/unauthorized/[slug]": Next.js encountered uncached or runtime data during the initial render.
